...
- `SunisuniQuestSystem`: 병원/약국/수니수니 동행 퀘스트
- `JjookQuestSystem`: 쭉쭉이/자판기/플로깅 보조 흐름
...
가장 먼저 할 만한 작업은 `SunisuniQuestSystem`이다. 병원/약국/처방전/약봉투/동행/퀴즈 흐름이 하나의 덩어리라 분리 효과가 크다.
