export const GAME_CONFIG = {
  ...
  jjookFollowBaseSpeed: 118,
  jjookClothesEscortSpeedMultiplier: 1.55,
  jjookFarDistance: 220,
  jjookFarSpeedMultiplier: 1.35,
  jjookFollowRepathMs: 700,
  jjookBusEscortRepathMs: 500,
  jjookFollowTargetMoveTolerance: 36,
  jjookBusEscortTargetMoveTolerance: 24,
  recycleDepositReward: 100,
  recycleQuestUnlockMoney: 20000,
  jjookQuestUnlockMoney: 58000,
  drinkPrice: 1000,
  speedBuffMultiplier: 1.35,
  speedBuffDurationMs: 60000,
  jjookFollowDurationMs: 60000,
  sunisuniQuestUnlockMoney: 90000,
  clothesQuestUnlockMoney: 95000,
  sunisuniSpeedMultiplier: 0.55,
  sunisuniFollowDistance: 72,
  sunisuniMaxDistance: 220,
  sunisuniFollowRepathMs: 800,
  sunisuniFollowTargetMoveTolerance: 34,
  sunisuniSpawn: { x: 398, y: 940 },
  sunisuniBench: { x: 398, y: 940 },
  sunisuniTree: { x: 1263, y: 646 },
  hospitalBuilding: { x: 280, y: 120 },
  pharmacyBuilding: { x: 481, y: 120 },
  hospitalDoor: { x: 280, y: 148 },
  pharmacyDoor: { x: 481, y: 148 },
