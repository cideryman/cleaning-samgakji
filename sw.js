...
const PRECACHE_URLS = [
  ...
  "./assets/vehicles/car-yellow-left.png",
  "./assets/vehicles/car-blue-left.png",
  "./assets/vehicles/car-white-left.png",
  "./assets/vehicles/car-red-right.png",
  "./assets/vehicles/car-white-right.png",
  ...
  "./assets/endings/chapter1-ending-scene.png",
  ...
  "./assets/backgrounds/start-park.png",
  "./assets/tiles/custom-grass.png",
  "./assets/tiles/bush-1.png",
  "./assets/tiles/bush-2.png",
  "./assets/tiles/bush-3.png",
  "./assets/tiles/bush-4.png",
  "./assets/tiles/brick-curb.png",
  "./assets/tiles/grass-curb-1.png",
  "./assets/tiles/grass-curb-2.png",
  "./assets/tiles/grass-curb-3.png",
  "./assets/tiles/grass-curb-4.png",
  "./assets/tiles/weed-curb.png",
  "./assets/tiles/vehicle-stop-line.png",
  "./assets/ui/broom-button.png",
  "./assets/ui/yebi-button.png",
  "./assets/ui/start-title-1.png",
  "./assets/ui/start-title-2.png",
  "./assets/ui/button-start-game.png",
  ...
  "./assets/audio/voice/thanks.mp3",
  "./assets/audio/voice/collect-cans.mp3",
  "./assets/audio/voice/i-will-help.mp3",
  "./assets/audio/voice/clear-slime.mp3",
  "./assets/audio/bgm/chapter1.mp3",
  "./assets/audio/bgm/prologue-room.wav",
  "./assets/audio/bgm/prologue-summer.wav",
  "./assets/audio/bgm/prologue-park.wav",
  "./assets/audio/bgm/chapter1-ending.wav",
  "./assets/audio/bgm/ambient-clothing-shop.wav",
  "./assets/audio/bgm/ambient-hospital.wav",
  "./assets/audio/bgm/ambient-pharmacy.wav",
  "./assets/audio/bgm/ambient-bus.wav",
  "./assets/audio/bgm/ambient-room.wav",
  "./assets/audio/bgm/ambient-train.wav",
  "./assets/audio/bgm/ambient-seoul-station.wav",
  "./assets/audio/bgm/ambient-gyeongbokgung.wav",
  "./assets/audio/bgm/ambient-amusement-park.wav",
